...
<?php if( have_rows('accordion_items') ) : ?>
    <section class="custom_accordion <?= esc_attr($variant_class); ?>">
        <div class="wrapper custom_accordion_wrapper">
            <div class="custom_accordion_card">
